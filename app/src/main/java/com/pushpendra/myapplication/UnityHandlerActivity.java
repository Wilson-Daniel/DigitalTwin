...
public class UnityHandlerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(UnityHandlerActivity.this,LoginActivity.class));
            }
        });
            ...
            mAuth.createUserWithEmailAndPassword(remail,rpassword).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if(task.isSuccessful()){
                        Toast.makeText(UnityHandlerActivity.this, "User registered succesfully", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(UnityHandlerActivity.this,LoginActivity.class));
                    }else{
                        Toast.makeText(UnityHandlerActivity.this, "Registeration Error"+task.getException().getMessage(), Toast.LENGTH_SHORT).show();
            ...
            try {
                ...
                FirebaseAuth.getInstance().signInWithCredential(credential)
                        .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    Toast.makeText(UnityHandlerActivity.this, "Signed in succesfully", Toast.LENGTH_SHORT).show();
                                    Intent intent = new Intent(getApplicationContext(), OptionActivity.class);
                                    startActivity(intent);
                                } else {
                                    Toast.makeText(UnityHandlerActivity.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
